                ...
                <div className="col-lg-8 mt-lg-0 mt-20">
                    <div className="row gap-sm-0">
                        <div className="col-md-4 col-6 mb-lg-0 mb-25">
                            ...
                            <FooterItem firstLink="About Us" secondLink="Press Release" thirdLink="Terms of Use" fourthLink="Privacy & Policy"/>
                        </div>
                        <div className="col-md-4 col-6 mb-lg-0 mb-25">
                            <p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
                            <FooterItem firstLink="Policy" secondLink="Rewards" thirdLink="Chatting" fourthLink=""/>
                        </div>
